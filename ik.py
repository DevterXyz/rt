...
")
ip = str(input("\033[96m Ip/Host \033[35m  :\033[91m "))
port = int(input("\033[96m Prot \033[35m  :\033[91m "))
...
def attack(ip, port, time, size):
    ...
    print(brand)
    print("\033[35m     ΣXCUTED ++ Attacked")
    fmt = '\033[91mZXZ Attack To >>> Ip {ip} Port {port}'.format
        ip=ip,
